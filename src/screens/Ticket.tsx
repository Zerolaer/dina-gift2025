  ...
  return (
    <div className="vh-screen w-full relative flex items-center justify-center overflow-hidden">
      <motion.div animate={controls} className="w-[320px]">
        <div className="relative rounded-3xl bg-white text-deep shadow-2xl overflow-hidden">
          <div className="p-5">
          ...
          <div className="p-5">
            ...
            <button onClick={onNext} className="w-full rounded-xl bg-deep text-white py-3 font-bold hover:opacity-90 active:scale-[.98] transition">
              Это твой подарок
            </button>
          </div>
        </div>
